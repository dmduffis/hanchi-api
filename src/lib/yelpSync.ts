...
const COMMUNITY_SEARCH_TERMS: Record<string, string | string[]> = {
  ...
  "wooster-square-ct": ["italian", "pizza", "apizza"],
  "little-poland-new-britain": ["polish", "pierogi", "eastern european"],
  "park-street-hartford": ["puerto rican", "caribbean", "latin"],
  "south-end-hartford": ["italian", "pizza"],
  "hollow-bridgeport": ["portuguese", "brazilian", "bacalhau"],
  "little-italy-bridgeport": ["italian", "pizza"],
  "danbury-brazilian": ["brazilian", "churrascaria", "latin"],
  "stamford-caribbean": ["jamaican", "caribbean", "west indian"],
  "fair-haven-ct": ["puerto rican", "latin", "mexican"],
  "little-havana-miami": ["cuban", "latin", "caribbean"],
  "little-haiti-miami": ["haitian", "caribbean", "creole"],
  "hialeah-miami": ["cuban", "latin"],
  "sweetwater-miami": ["nicaraguan", "central american", "latin"],
  "allapattah-miami": ["dominican", "latin", "caribbean"],
  "westchester-miami": ["colombian", "latin"],
  "doral-miami": ["venezuelan", "arepas", "latin"],
  "mills-50-orlando": ["vietnamese", "pho", "banh mi"],
  "pine-hills-orlando": ["jamaican", "caribbean", "west indian"],
  "azalea-park-orlando": ["colombian", "latin"],
  "kissimmee-orlando": ["puerto rican", "caribbean", "latin"],
  "cedar-riverside-minneapolis": ["somali", "east african", "halal"],
  "little-mekong-stpaul": ["hmong", "vietnamese", "thai", "laotian"],
  "hmongtown-stpaul": ["hmong", "southeast asian", "vietnamese"],
  "lake-street-minneapolis": ["mexican", "latin", "taqueria"],
  "eat-street-minneapolis": ["vietnamese", "asian", "chinese"],
  "district-del-sol-stpaul": ["mexican", "latin", "taqueria"],
  "central-ave-minneapolis": ["mexican", "latin"],
